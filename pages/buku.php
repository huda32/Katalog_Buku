              ...
              <?php 
                ...
                while ($row = mysqli_fetch_assoc($rs)) {
                    ...
                    <div class="product-item">
                        ...
                        <h3>
                            <a title="<?php $row['judul_buku']; ?>" class="product-title" href="?p=buku_detail&id_buku=<?php echo $row['id_buku']; ?>"><b><?php echo substr($row['judul_buku'], 0, 35);
          ...
          <aside class="col-md-3 sidebar left-sidebar">
            ...
            <div class="widget bestsellers">
              <div class="products-widget">
                <h3 class="widget-title uppercase">Book of The Week</h3>
                <?php
